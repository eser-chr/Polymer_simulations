...
'''
# Since they are structure specific.. put them into a class. also use njit
def get_label(ide, char):
    return list(data[data['id']==ide][char])[0]

def exp(ide):
    trajectroy_folder = '../../agroups/goloborodko/projects/chris/trajectory'  # Dirty architecture
    return f'{trajectroy_folder}/{ide}.gsd'
